...
from can_mayor.blueprints.tareas.models import Tarea
from can_mayor.blueprints.usuarios_roles.models import UsuarioRol
from can_mayor.extensions import database, pwd_context
...
class Usuario(database.Model, UserMixin, UniversalMixin):
            ...
            if usuario_rol.estatus == "A":
                for permiso in usuario_rol.rol.permisos:
                    if (
                        ...
                        and permiso.modulo.en_plataforma_can_mayor
                    ):
    ...
    def launch_task(self, comando, mensaje, *args, **kwargs):
        ...
        rq_job = current_app.task_queue.enqueue(f"can_mayor.blueprints.{comando}", *args, **kwargs)
