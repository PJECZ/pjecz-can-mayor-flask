...
from can_mayor.blueprints.permisos.forms import PermisoEditForm, PermisoNewWithModuloForm, PermisoNewWithRolForm
...
def datatable_json():
    ...
    consulta = consulta.join(Modulo).filter(Modulo.en_plataforma_can_mayor == True)
